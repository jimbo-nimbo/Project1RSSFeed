public class Test {
  ...
  //    rssService.addWebSite("http://www.irinn.ir/fa/rss/allnews", "body", "dd MMM yyyy HH:mm:ss
  // zzz");
  ...
  //    rssService.addWebSite("https://www.yjc.ir/fa/rss/allnews", "body", "dd MMM yyyy HH:mm:ss
  // zzz");
  //    rssService.addWebSite("https://www.isna.ir/rss", "item-text", "E, dd MMM yyyy HH:mm:ss
  // zzz");
  //
